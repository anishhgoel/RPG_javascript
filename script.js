...
},
{
    ...
    text : 'You found a secret game. Pick a number above. Ten numbers will be randomly chosen in between 1 and 10. If the number you choose matches one of the random numbers, you win'
}
